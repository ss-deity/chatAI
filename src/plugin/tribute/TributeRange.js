...
class TributeRange {
    ...
    positionMenuAtCaret(scrollTo) {
        ...
        if (typeof info !== 'undefined') {
            ...
            if(!this.tribute.positionMenu){
                this.tribute.menu.style.cssText = `display: flex;`
                return
            }
    ...
    replaceTriggerText(text, requireLeadingSpace, hasTrailingSpace, originalEvent, item) {
        ...
        if (info !== undefined && item) {
            ...
            if (!this.isContentEditable(context.element)) {
                ...
                this.pasteHtml(text, info.mentionPosition, endPos, item, context.element)
            }
    ...
    pasteHtml(html, startPos, endPos, item, element) {
        let range, sel
        ...
        el.firstChild.addEventListener('click', (e) => {
            let replaceEvent = new CustomEvent('tag-click', {
                detail: {
                    data: item,
                    context,
                    originalEvent: e
            ...
            } else if (element.value && element.value.dispatchEvent){
                element.value.dispatchEvent(replaceEvent)
            }
        }, false);
    ...
    getFixedCoordinatesRelativeToRect(rect) {
        ...
        if (availableSpaceOnBottom < menuDimensions.height || this.tribute.fixedPosition === 'top') {
